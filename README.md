...
To enable **Wifi** in the demo (recommended - gets time from NTP), select `TFT Display DEMO Configuration` from the top-level menu, enable the `Use wifi in TFT Demo`, and configure the wifi settings.
